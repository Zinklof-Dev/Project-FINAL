namespace Bastion.ConsoleV2
{
    public static class Console
    {
        ...
        public static readonly string ReleaseVersion = "E-2603A";
        ...
        /// <summary>
        /// Prints a log message exclusively to the Bastion console.
        /// </summary>
        /// <param name="message">What content your log will contain.</param>
        /// <param name="prefix">What to prefix your log with (command name if blank).</param>
        /// <param name="hexColor">Specialize the color via hex codes (bright cyan blue if blank).</param>
        /// <param name="bold">Should your log be bold? (false if blank)</param>
        /// <param name="fontSize">What size text should your log be? (17 if blank)</param>
